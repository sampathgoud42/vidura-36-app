...
```bash
robocopy D:\_projects\vidura-36-app E:\tradier-bot /MIR /XD .venv node_modules __pycache__ .pytest_cache .git /XF *.pid
```
...
app.migrate INFO user sampath: credential folder repointed
            D:/_projects/vidura-36-app/customers/sampath -> ...\ship-test\customers\sampath
```
