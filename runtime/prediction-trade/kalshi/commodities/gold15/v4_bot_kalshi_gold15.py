#!/usr/bin/env python
"""Gold-15 v4 — trade when MOST of the DMI stack agrees and is building.
...
the ADX slope as the arrow beside the number, and v4 reads both:
    ...
    GOLD 405.24  1m 15 call↑  2m 37 call↑  5m 50 put↑  10m 34 call↓  -> YES
    GOLD 405.24  1m 15 put↓   2m 37 put↑   5m 50 put↑  10m 34 put↑   -> NO
...
Usage:
    v4_bot_kalshi_gold15.py [--live] [--once]
