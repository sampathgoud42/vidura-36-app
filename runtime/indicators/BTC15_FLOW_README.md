...
python D:\_projects\tradier-bot\runtime\prediction-trade\kalshi\btc\btc15\bot_btc_15_2.py >> bot_btc_15_2.out 2>&1
```
...
D:\_projects\tradier-bot\runtime\indicators\btc15_quarter.bat

:: manual fast refresh (past 24h only)
D:\_projects\tradier-bot\runtime\indicators\btc15_quarter.bat 1

:: rebake dashboard only (no fetch)
python D:\_projects\tradier-bot\runtime\indicators\bake_btc15_dashboard.py
...
:: logs
type D:\_projects\tradier-bot\runtime\indicators\btc15_quarter.log
type D:\_projects\tradier-bot\customers\sampath\bot_btc_15_2.out
```
